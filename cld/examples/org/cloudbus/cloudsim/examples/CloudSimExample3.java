...
/**
 * A simple example showing how to create a datacenter with two hosts and run two
 * cloudlets on it. The cloudlets run in VMs with different MIPS requirements.
 * The cloudlets will take different time to complete the execution depending on 
